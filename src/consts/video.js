...
export const NATIVE_MESSAGE = {
  ...
  RELAY_HANDSHAKE_FAILED: 28,
  RELAY_REMOTE_CONFIG_CHANGED: 29,
  RELAY_DATA_USAGE: 30,
  RESPONSE_RESOLUTION: 31,
...
export const BUFFER_TIMEOUT = 21000;
...
export const HLS_DATA_REQUEST_TIMEOUT = /*__DEV__ ? 5000 :*/ 7000;
export const HLS_GET_DATA_DIRECTLY_TIMEOUT = 2000;
export const HLS_MAX_RETRY = 21;
...
export const REFRESH_TIMELINE_INTERVAL = 30000;
