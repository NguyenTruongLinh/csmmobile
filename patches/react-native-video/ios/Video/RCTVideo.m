...
{
    CVPixelBufferRef buffer = [_playerOutput copyPixelBufferForItemTime:[_playerItem currentTime] itemTimeForDisplay:nil];
    ...
    UIImageWriteToSavedPhotosAlbum(uiImage, nil, nil, nil);
        NSLog(@"0530 UIImageWriteToSavedPhotosAlbum");
    
    if(self.onSnapshotSuccess) {
      self.onSnapshotSuccess(@{@"target": self.reactTag});
    }
}
