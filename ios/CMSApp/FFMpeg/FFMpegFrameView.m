...
//    {
      ...
      NSLog(@"2908 setDisconnect IMC_MSG_CONNECTION_DISCONNECT");
//    }
...
-(void)setStop:(BOOL)stop{
  ...
  if(stop){
    ...
    if(connectedServerList.count > 0)
    {
      ...
      [self handleResponseMessage:IMC_MSG_CONNECTION_DISCONNECT fromView:self withData:nil];
      NSLog(@"2908 setStop IMC_MSG_CONNECTION_DISCONNECT");
      [connectedServerList removeAllObjects];
    }
...
- (NSString*) messIdToString:(IMC_MSG_BASE)messageId
{
  switch (messageId) {
    case IMC_MSG_CONNECTION_BACK: return @"IMC_MSG_CONNECTION_BACK";
    case IMC_MSG_CONNECTION_CONNECT: return @"IMC_MSG_CONNECTION_CONNECT";
    case IMC_MSG_CONNECTION_DISCONNECT: return @"IMC_MSG_CONNECTION_DISCONNECT";
    case IMC_MSG_CONNECTION_CANCEL: return @"IMC_MSG_CONNECTION_CANCEL";
    case IMC_MSG_GET_CONNECTION_NUMBER: return @"IMC_MSG_GET_CONNECTION_NUMBER";
    case IMC_MSG_GET_CONNECTION_NUMBER_RESPONSE: return @"IMC_MSG_GET_CONNECTION_NUMBER_RESPONSE";
    case IMC_MSG_CONNECTION_NEED_RESET: return @"IMC_MSG_CONNECTION_NEED_RESET";

    case IMC_MSG_ABOUT: return @"IMC_MSG_ABOUT";
    case IMC_MSG_ABOUT_BACK: return @"IMC_MSG_ABOUT_BACK";

    case IMC_MSG_SETTINGS_BACK: return @"IMC_MSG_SETTINGS_BACK";
    case IMC_MSG_SETTINGS_SAVE: return @"IMC_MSG_SETTINGS_SAVE";

    case IMC_MSG_ADD_SERVER_DONE: return @"IMC_MSG_ADD_SERVER_DONE";
    case IMC_MSG_ADD_SERVER_CANCEL: return @"IMC_MSG_ADD_SERVER_CANCEL";

    case IMC_MSG_ALARM_SETTING_CANCEL: return @"IMC_MSG_ALARM_SETTING_CANCEL";
    case IMC_MSG_ALARM_SETTING_SAVE: return @"IMC_MSG_ALARM_SETTING_SAVE";

    case IMC_MSG_DISPLAY_UPDATE_LAYOUT: return @"IMC_MSG_DISPLAY_UPDATE_LAYOUT";
    case IMC_MSG_DISPLAY_FULLSCREEN: return @"IMC_MSG_DISPLAY_FULLSCREEN";
    case IMC_MSG_DISPLAY_SHOW_PTZ_PANEL: return @"IMC_MSG_DISPLAY_SHOW_PTZ_PANEL";
    case IMC_MSG_DISPLAY_HIDE_PTZ_PANEL: return @"IMC_MSG_DISPLAY_HIDE_PTZ_PANEL";

    case IMC_MSG_CHANNEL_MAPPING_CANCEL: return @"IMC_MSG_CHANNEL_MAPPING_CANCEL";
    case IMC_MSG_CHANNEL_MAPPING_SAVE: return @"IMC_MSG_CHANNEL_MAPPING_SAVE";
    case IMC_MSG_CHANNEL_MAPPING_SNAPSHOT_SCREEN: return @"IMC_MSG_CHANNEL_MAPPING_SNAPSHOT_SCREEN";
    case IMC_MSG_CHANNEL_MAPPING_GET_SERVER_CHANNEL_INFO: return @"IMC_MSG_CHANNEL_MAPPING_GET_SERVER_CHANNEL_INFO";
    case IMC_MSG_CHANNEL_MAPPING_UPDATE_CHANNEL_MASK: return @"IMC_MSG_CHANNEL_MAPPING_UPDATE_CHANNEL_MASK";


    case IMC_MSG_MAIN_VIEW_ADD_SERVER: return @"IMC_MSG_MAIN_VIEW_ADD_SERVER";
    case IMC_MSG_MAIN_VIEW_REMOVE_SERVER: return @"IMC_MSG_MAIN_VIEW_REMOVE_SERVER";
    case IMC_MSG_MAIN_VIEW_UPDATE_SERVER: return @"IMC_MSG_MAIN_VIEW_UPDATE_SERVER";
    case IMC_MSG_MAIN_VIEW_UPDATE_SERVER_RESPONSE: return @"IMC_MSG_MAIN_VIEW_UPDATE_SERVER_RESPONSE";
    case IMC_MSG_MAIN_VIEW_ADD_GROUP: return @"IMC_MSG_MAIN_VIEW_ADD_GROUP";
    case IMC_MSG_MAIN_VIEW_SELECT_GROUP: return @"IMC_MSG_MAIN_VIEW_SELECT_GROUP";
    case IMC_MSG_MAIN_VIEW_SELECT_GROUP_RESPONSE: return @"IMC_MSG_MAIN_VIEW_SELECT_GROUP_RESPONSE";
    case IMC_MSG_MAIN_VIEW_RENAME_GROUP: return @"IMC_MSG_MAIN_VIEW_RENAME_GROUP";
    case IMC_MSG_MAIN_VIEW_DELETE_GROUP: return @"IMC_MSG_MAIN_VIEW_DELETE_GROUP";
    case IMC_MSG_MAIN_VIEW_SELECT_NEW_SERVER: return @"IMC_MSG_MAIN_VIEW_SELECT_NEW_SERVER";
    case IMC_MSG_MAIN_VIEW_SELECT_NEW_SERVER_RESPONSE: return @"IMC_MSG_MAIN_VIEW_SELECT_NEW_SERVER_RESPONSE";
    case IMC_MSG_MAIN_VIEW_SELECT_CONNECTION: return @"IMC_MSG_MAIN_VIEW_SELECT_CONNECTION";
    case IMC_MSG_MAIN_VIEW_SELECT_CONNECTION_RESPONSE: return @"IMC_MSG_MAIN_VIEW_SELECT_CONNECTION_RESPONSE";
    case IMC_MSG_MAIN_VIEW_WAIT_TO_LIVE_VIEW: return @"IMC_MSG_MAIN_VIEW_WAIT_TO_LIVE_VIEW";
    case IMC_MSG_MAIN_VIEW_TO_LIVE_VIEW: return @"IMC_MSG_MAIN_VIEW_TO_LIVE_VIEW";
    case IMC_MSG_MAIN_VIEW_FAVORITE_CHANNELS: return @"IMC_MSG_MAIN_VIEW_FAVORITE_CHANNELS";
    case IMC_MSG_MAIN_VIEW_FAVORITE_CHANNELS_RESPONSE: return @"IMC_MSG_MAIN_VIEW_FAVORITE_CHANNELS_RESPONSE";
    case IMC_MSG_MAIN_VIEW_FAVORITE_CHANNELS_ADD: return @"IMC_MSG_MAIN_VIEW_FAVORITE_CHANNELS_ADD";
    case IMC_MSG_MAIN_VIEW_FAVORITE_CHANNELS_ADD_RESPONSE: return @"IMC_MSG_MAIN_VIEW_FAVORITE_CHANNELS_ADD_RESPONSE";
    case IMC_MSG_MAIN_VIEW_ADD_SERVER_TO_GROUP_BACK: return @"IMC_MSG_MAIN_VIEW_ADD_SERVER_TO_GROUP_BACK";
    case IMC_MSG_MAIN_VIEW_SERVER_CHANGE_INFO: return @"IMC_MSG_MAIN_VIEW_SERVER_CHANGE_INFO";
    case IMC_MSG_MAIN_VIEW_LIVE_VIEW_RESPONSE: return @"IMC_MSG_MAIN_VIEW_LIVE_VIEW_RESPONSE";
    case IMC_MSG_MAIN_VIEW_CMS_CONNECTION: return @"IMC_MSG_MAIN_VIEW_CMS_CONNECTION";
    case IMC_MSG_MAIN_VIEW_CMS_CONNECTION_CLOSE: return @"IMC_MSG_MAIN_VIEW_CMS_CONNECTION_CLOSE";
    case IMC_MSG_MAIN_VIEW_DISABLE_CMS: return @"IMC_MSG_MAIN_VIEW_DISABLE_CMS";
    case IMC_MSG_MAIN_VIEW_SWITCH_FROM_CMS: return @"IMC_MSG_MAIN_VIEW_SWITCH_FROM_CMS";

    case IMC_MSG_LIVE_VIEW_SELECT_RATIO_VIEW: return @"IMC_MSG_LIVE_VIEW_SELECT_RATIO_VIEW";
    case IMC_MSG_LIVE_VIEW_SELECT_RATIO_VIEW_RESPONSE: return @"IMC_MSG_LIVE_VIEW_SELECT_RATIO_VIEW_RESPONSE";
    case IMC_MSG_LIVE_VIEW_SELECT_ALARM_SETTING: return @"IMC_MSG_LIVE_VIEW_SELECT_ALARM_SETTING";
    case IMC_MSG_LIVE_VIEW_SELECT_ALARM_SETTING_RESPONSE: return @"IMC_MSG_LIVE_VIEW_SELECT_ALARM_SETTING_RESPONSE";
    case IMC_MSG_LIVE_VIEW_SELECT_FPS: return @"IMC_MSG_LIVE_VIEW_SELECT_FPS";
    case IMC_MSG_LIVE_VIEW_SELECT_FPS_RESPONSE: return @"IMC_MSG_LIVE_VIEW_SELECT_FPS_RESPONSE";
    case IMC_MSG_LIVE_VIEW_SELECT_VIDEO_QUALITY: return @"IMC_MSG_LIVE_VIEW_SELECT_VIDEO_QUALITY";
    case IMC_MSG_LIVE_VIEW_SELECT_VIDEO_QUALITY_RESPONSE: return @"IMC_MSG_LIVE_VIEW_SELECT_VIDEO_QUALITY_RESPONSE";
    case IMC_MSG_LIVE_VIEW_SELECT_VIEW_ALARM: return @"IMC_MSG_LIVE_VIEW_SELECT_VIEW_ALARM";
    case IMC_MSG_LIVE_VIEW_SELECT_VIEW_ALARM_RESPONSE: return @"IMC_MSG_LIVE_VIEW_SELECT_VIEW_ALARM_RESPONSE";
    case IMC_MSG_LIVE_VIEW_SELECT_ALARM_FILTER: return @"IMC_MSG_LIVE_VIEW_SELECT_ALARM_FILTER";
    case IMC_MSG_LIVE_VIEW_SELECT_ALARM_FILTER_RESPONSE: return @"IMC_MSG_LIVE_VIEW_SELECT_ALARM_FILTER_RESPONSE";
    case IMC_MSG_LIVE_VIEW_SELECT_CHANNEL_MAPPING: return @"IMC_MSG_LIVE_VIEW_SELECT_CHANNEL_MAPPING";
    case IMC_MSG_LIVE_VIEW_SELECT_CHANNEL_MAPPING_RESPONSE: return @"IMC_MSG_LIVE_VIEW_SELECT_CHANNEL_MAPPING_RESPONSE";
    case IMC_MSG_LIVE_VIEW_SELECT_CHANNEL_DEFAULT: return @"IMC_MSG_LIVE_VIEW_SELECT_CHANNEL_DEFAULT";
    case IMC_MSG_CHANNEL_MAPPING_SELECT_VIEW: return @"IMC_MSG_CHANNEL_MAPPING_SELECT_VIEW";
    case IMC_MSG_CHANNEL_MAPPING_SELECT_VIEW_RESPONSE: return @"IMC_MSG_CHANNEL_MAPPING_SELECT_VIEW_RESPONSE";
    case IMC_MSG_LIVE_VIEW_DETAIL_SETTING_BACK: return @"IMC_MSG_LIVE_VIEW_DETAIL_SETTING_BACK";
    case IMC_MSG_LIVE_VIEW_UPDATE_VIDEO_DISPLAY_MASK: return @"IMC_MSG_LIVE_VIEW_UPDATE_VIDEO_DISPLAY_MASK";
    case IMC_MSG_LIVE_VIEW_SETTING_SELECT_SERVER: return @"IMC_MSG_LIVE_VIEW_SETTING_SELECT_SERVER";
    case IMC_MSG_LIVE_VIEW_SETTING_SELECT_SERVER_BACK: return @"IMC_MSG_LIVE_VIEW_SETTING_SELECT_SERVER_BACK";
    case IMC_MSG_LIVE_VIEW_SETTING_SAVE: return @"IMC_MSG_LIVE_VIEW_SETTING_SAVE";
    case IMC_MSG_LIVE_VIEW_REFRESH_SCREEN: return @"IMC_MSG_LIVE_VIEW_REFRESH_SCREEN";
    case IMC_MSG_LIVE_SETTING_BACK: return @"IMC_MSG_LIVE_SETTING_BACK";
    case IMC_MSG_LIVE_VIEW_CHANGE_MAINSUB_STATUS: return @"IMC_MSG_LIVE_VIEW_CHANGE_MAINSUB_STATUS";
    case IMC_MSG_LIVE_VIEW_DISABLE_TABBARITEM: return @"IMC_MSG_LIVE_VIEW_DISABLE_TABBARITEM";


    case IMC_MSG_LIVE_VIEW_PTZ_LEFT: return @"IMC_MSG_LIVE_VIEW_PTZ_LEFT";
    case IMC_MSG_LIVE_VIEW_PTZ_RIGHT: return @"IMC_MSG_LIVE_VIEW_PTZ_RIGHT";
    case IMC_MSG_LIVE_VIEW_PTZ_UP: return @"IMC_MSG_LIVE_VIEW_PTZ_UP";
    case IMC_MSG_LIVE_VIEW_PTZ_DOWN: return @"IMC_MSG_LIVE_VIEW_PTZ_DOWN";
    case IMC_MSG_LIVE_VIEW_PTZ_LEFTUP: return @"IMC_MSG_LIVE_VIEW_PTZ_LEFTUP";
    case IMC_MSG_LIVE_VIEW_PTZ_RIGHTUP: return @"IMC_MSG_LIVE_VIEW_PTZ_RIGHTUP";
    case IMC_MSG_LIVE_VIEW_PTZ_LEFTDOWN: return @"IMC_MSG_LIVE_VIEW_PTZ_LEFTDOWN";
    case IMC_MSG_LIVE_VIEW_PTZ_RIGHTDOWN: return @"IMC_MSG_LIVE_VIEW_PTZ_RIGHTDOWN";
    case IMC_MSG_LIVE_VIEW_PTZ_ZOOMIN: return @"IMC_MSG_LIVE_VIEW_PTZ_ZOOMIN";
    case IMC_MSG_LIVE_VIEW_PTZ_ZOOMOUT: return @"IMC_MSG_LIVE_VIEW_PTZ_ZOOMOUT";
    case IMC_MSG_LIVE_VIEW_PTZ_LEFT_STOP: return @"IMC_MSG_LIVE_VIEW_PTZ_LEFT_STOP";
    case IMC_MSG_LIVE_VIEW_PTZ_RIGHT_STOP: return @"IMC_MSG_LIVE_VIEW_PTZ_RIGHT_STOP";
    case IMC_MSG_LIVE_VIEW_PTZ_UP_STOP: return @"IMC_MSG_LIVE_VIEW_PTZ_UP_STOP";
    case IMC_MSG_LIVE_VIEW_PTZ_DOWN_STOP: return @"IMC_MSG_LIVE_VIEW_PTZ_DOWN_STOP";
    case IMC_MSG_LIVE_VIEW_PTZ_LEFTUP_STOP: return @"IMC_MSG_LIVE_VIEW_PTZ_LEFTUP_STOP";
    case IMC_MSG_LIVE_VIEW_PTZ_RIGHTUP_STOP: return @"IMC_MSG_LIVE_VIEW_PTZ_RIGHTUP_STOP";
    case IMC_MSG_LIVE_VIEW_PTZ_LEFTDOWN_STOP: return @"IMC_MSG_LIVE_VIEW_PTZ_LEFTDOWN_STOP";
    case IMC_MSG_LIVE_VIEW_PTZ_RIGHTDOWN_STOP: return @"IMC_MSG_LIVE_VIEW_PTZ_RIGHTDOWN_STOP";
    case IMC_MSG_LIVE_VIEW_PTZ_ZOOMIN_STOP: return @"IMC_MSG_LIVE_VIEW_PTZ_ZOOMIN_STOP";
    case IMC_MSG_LIVE_VIEW_PTZ_ZOOMOUT_STOP: return @"IMC_MSG_LIVE_VIEW_PTZ_ZOOMOUT_STOP";
    case IMC_MSG_LIVE_VIEW_REQUEST_SNAPSHOT: return @"IMC_MSG_LIVE_VIEW_REQUEST_SNAPSHOT";
    case IMC_MSG_LIVE_VIEW_CANCEL_SNAPSHOT: return @"IMC_MSG_LIVE_VIEW_CANCEL_SNAPSHOT";
    case IMC_MSG_LIVE_VIEW_EMAIL_SNAPSHOT: return @"IMC_MSG_LIVE_VIEW_EMAIL_SNAPSHOT";
    case IMC_MSG_LIVE_VIEW_STOP_VIDEO: return @"IMC_MSG_LIVE_VIEW_STOP_VIDEO";
    case IMC_MSG_LIVE_VIEW_START_VIDEO: return @"IMC_MSG_LIVE_VIEW_START_VIDEO";
    case IMC_MSG_LIVE_VIEW_SELECT_ALARM_SETTING_DEFAULT: return @"IMC_MSG_LIVE_VIEW_SELECT_ALARM_SETTING_DEFAULT";
    case IMC_MSG_LIVE_VIEW_SELECT_ALARM_SETTING_DEFAULT_RESPONSE: return @"IMC_MSG_LIVE_VIEW_SELECT_ALARM_SETTING_DEFAULT_RESPONSE";
    case IMC_MSG_LIVE_VIEW_SELECT_ALARM_VOLUME: return @"IMC_MSG_LIVE_VIEW_SELECT_ALARM_VOLUME";
    case IMC_MSG_LIVE_VIEW_SELECT_ALARM_VOLUME_UPDATE: return @"IMC_MSG_LIVE_VIEW_SELECT_ALARM_VOLUME_UPDATE";
    case IMC_MSG_LIVE_VIEW_REMOVE_CHANNEL: return @"IMC_MSG_LIVE_VIEW_REMOVE_CHANNEL";
    case IMC_MSG_LIVE_VIEW_STOP_RECORDING: return @"IMC_MSG_LIVE_VIEW_STOP_RECORDING";
    case IMC_MSG_LIVE_VIEW_HIDE_MENU_BAR: return @"IMC_MSG_LIVE_VIEW_HIDE_MENU_BAR";
    case IMC_MSG_LIVE_REQUEST_MAIN_STREAM: return @"IMC_MSG_LIVE_REQUEST_MAIN_STREAM";
    case IMC_MSG_LIVE_REQUEST_SUB_STREAM: return @"IMC_MSG_LIVE_REQUEST_SUB_STREAM";
    case IMC_MSG_LIVE_SWIPE_SCREEN: return @"IMC_MSG_LIVE_SWIPE_SCREEN";
    case IMC_MSG_LIVE_UPDATE_CHANNEL_MASK: return @"IMC_MSG_LIVE_UPDATE_CHANNEL_MASK";

    case IMC_MSG_CREATE_ACCOUNT: return @"IMC_MSG_CREATE_ACCOUNT";
    case IMC_MSG_FORGOT_PASSWORD: return @"IMC_MSG_FORGOT_PASSWORD";
    case IMC_MSG_ALARM_LIST_CUR_PAGE: return @"IMC_MSG_ALARM_LIST_CUR_PAGE";
    case IMC_MSG_ALARM_LIST_CUR_PAGE_RESPONSE: return @"IMC_MSG_ALARM_LIST_CUR_PAGE_RESPONSE";
    case IMC_MSG_ALARM_LIST_NEXT_PAGE: return @"IMC_MSG_ALARM_LIST_NEXT_PAGE";
    case IMC_MSG_ALARM_LIST_NEXT_PAGE_RESPONSE: return @"IMC_MSG_ALARM_LIST_NEXT_PAGE_RESPONSE";
    case IMC_MSG_ALARM_LIST_PREV_PAGE: return @"IMC_MSG_ALARM_LIST_PREV_PAGE";
    case IMC_MSG_ALARM_LIST_PREV_PAGE_RESPONSE: return @"IMC_MSG_ALARM_LIST_PREV_PAGE_RESPONSE";
    case IMC_MSG_ALARM_LIST_EXIT: return @"IMC_MSG_ALARM_LIST_EXIT";
    case IMC_MSG_ALARM_PLAY_A_SOUND: return @"IMC_MSG_ALARM_PLAY_A_SOUND";
    case IMC_MSG_ALARM_PLAY_A_SOUND_RESPONSE: return @"IMC_MSG_ALARM_PLAY_A_SOUND_RESPONSE";
    case IMC_MSG_ALARM_LIST_BACK: return @"IMC_MSG_ALARM_LIST_BACK";

    case IMC_MSG_FAVORITE_ADD_GROUP: return @"IMC_MSG_FAVORITE_ADD_GROUP";
    case IMC_MSG_FAVORITE_DELETE_GROUP: return @"IMC_MSG_FAVORITE_DELETE_GROUP";
    case IMC_MSG_FAVORITE_EDIT_GROUP_NAME: return @"IMC_MSG_FAVORITE_EDIT_GROUP_NAME";
    case IMC_MSG_FAVORITE_EDIT_GROUP_NAME_RESPONSE: return @"IMC_MSG_FAVORITE_EDIT_GROUP_NAME_RESPONSE";
    case IMC_MSG_FAVORITE_SAVE_FAVORITE_GROUP: return @"IMC_MSG_FAVORITE_SAVE_FAVORITE_GROUP";
    case IMC_MSG_FAVORITE_CHANNEL_ON_BACK: return @"IMC_MSG_FAVORITE_CHANNEL_ON_BACK";
    case IMC_MSG_FAVORITE_CHANNEL_GET_CONNECTION_SERVER: return @"IMC_MSG_FAVORITE_CHANNEL_GET_CONNECTION_SERVER";
    case IMC_MSG_FAVORITE_CHANNEL_ON_BACK_TO_FAVORITE_GROUP_VIEW: return @"IMC_MSG_FAVORITE_CHANNEL_ON_BACK_TO_FAVORITE_GROUP_VIEW";
    case IMC_MSG_FAVORITE_CHANNEL_ON_ADD_CHANNELS: return @"IMC_MSG_FAVORITE_CHANNEL_ON_ADD_CHANNELS";
    case IMC_MSG_FAVORITE_CHANNEL_SAVE_CHANNELS: return @"IMC_MSG_FAVORITE_CHANNEL_SAVE_CHANNELS";
    case IMC_MSG_FAVORITE_DELETE_CHANNEL: return @"IMC_MSG_FAVORITE_DELETE_CHANNEL";
    case IMC_MSG_FAVORITE_CONNECTION_CONNECT: return @"IMC_MSG_FAVORITE_CONNECTION_CONNECT";
    case IMC_MSG_FAVORITE_REQUEST_DISCONNECT_ALL: return @"IMC_MSG_FAVORITE_REQUEST_DISCONNECT_ALL";
    case IMC_MSG_FAVORITE_CHANNEL_BACK: return @"IMC_MSG_FAVORITE_CHANNEL_BACK";
    case IMC_MSG_FAVORITE_CHANNEL_CONNECT_CHANNEL: return @"IMC_MSG_FAVORITE_CHANNEL_CONNECT_CHANNEL";
    case IMC_MSG_FAVORITE_REQUEST_DISCONNECT_SERVER: return @"IMC_MSG_FAVORITE_REQUEST_DISCONNECT_SERVER";
    case IMC_MSG_FAVORITE_RESPONSE_SERVER_INFO: return @"IMC_MSG_FAVORITE_RESPONSE_SERVER_INFO";
    case IMC_MSG_FAVORITE_RESPONSE_NO_CHANGE: return @"IMC_MSG_FAVORITE_RESPONSE_NO_CHANGE";
    case IMC_MSG_FAVORITE_START_EDITING: return @"IMC_MSG_FAVORITE_START_EDITING";
    case IMC_MSG_ADD_FAVORITE_FROM_LIVE_BACK: return @"IMC_MSG_ADD_FAVORITE_FROM_LIVE_BACK";
    case IMC_MSG_MAIN_VIEW_SAVE_BEFORE_CLOSE: return @"IMC_MSG_MAIN_VIEW_SAVE_BEFORE_CLOSE";
    case IMC_MSG_MAIN_DISPLAY_VIDEO_UPDATE_FRAME_RESOLUTION: return @"IMC_MSG_MAIN_DISPLAY_VIDEO_UPDATE_FRAME_RESOLUTION";

    case IMC_MSG_SEARCH_GROUP: return @"IMC_MSG_SEARCH_GROUP";
    case IMC_MSG_SEARCH_REQUEST_TIME_ZONE: return @"IMC_MSG_SEARCH_REQUEST_TIME_ZONE";
    case IMC_MSG_SEARCH_CHOSEN_DAY_RESPONSE: return @"IMC_MSG_SEARCH_CHOSEN_DAY_RESPONSE";
    case IMC_MSG_SEARCH_REQUEST_TIME_INTERVAL: return @"IMC_MSG_SEARCH_REQUEST_TIME_INTERVAL";
    case IMC_MSG_SEARCH_UPDATE_TODAY_CELL: return @"IMC_MSG_SEARCH_UPDATE_TODAY_CELL";
    case IMC_MSG_SEARCH_REQUEST_THUMBNAIL: return @"IMC_MSG_SEARCH_REQUEST_THUMBNAIL";
    case IMC_MSG_SEARCH_REQUEST_PLAY_FW: return @"IMC_MSG_SEARCH_REQUEST_PLAY_FW";
    case IMC_MSG_SEARCH_REQUEST_STOP: return @"IMC_MSG_SEARCH_REQUEST_STOP";
    case IMC_MSG_SEARCH_REQUEST_SET_POS: return @"IMC_MSG_SEARCH_REQUEST_SET_POS";
    case IMC_MSG_SEARCH_REQUEST_STEP_BW: return @"IMC_MSG_SEARCH_REQUEST_STEP_BW";
    case IMC_MSG_SEARCH_REQUEST_STEP_FW: return @"IMC_MSG_SEARCH_REQUEST_STEP_FW";
    case IMC_MSG_SEARCH_RESET_DECODER_FOR_LIVE: return @"IMC_MSG_SEARCH_RESET_DECODER_FOR_LIVE";
    case IMC_MSG_SEARCH_RESET_DECODER_FOR_SEARCH: return @"IMC_MSG_SEARCH_RESET_DECODER_FOR_SEARCH";
    case IMC_MSG_SEARCH_REQUEST_SNAPSHOT: return @"IMC_MSG_SEARCH_REQUEST_SNAPSHOT";
    case IMC_MSG_SEARCH_REQUEST_REFRESH_CALENDAR: return @"IMC_MSG_SEARCH_REQUEST_REFRESH_CALENDAR";
    case IMC_MSG_SEARCH_REQUEST_REFRESH_DECODER: return @"IMC_MSG_SEARCH_REQUEST_REFRESH_DECODER";
    case IMC_MSG_SEARCH_REQUEST_MAIN_SUB: return @"IMC_MSG_SEARCH_REQUEST_MAIN_SUB";
    default:
      return @"OTHERS";
  }
}
...
{
  NSLog(@"2908 hdlResMess %@", [self messIdToString: messageId]);
  switch (messageId) {
          ...
          else
          {
            ...
            if(found_server)
            {
              ...
              if(resumeDataInfo.playbackInfo.selectedChannelIdx>=0)
              {
                ...
                NSLog(@"3008 2908 fullScreenSearchMode 1");
                [self fullScreenSearchMode:resumeDataInfo.playbackInfo.selectedChannelIdx:FALSE];
              }
              else
              {
                self.chosenDay = nil;
...
-(void)updateDataDateList:(NSTimeZone*)serverTimeZone
{
  ...
  if (currentServer)
  {
    ...
    {
      NSLog(@"3008 2908 fullScreenSearchMode 2");
      [self fullScreenSearchMode:currentSelectedFullScreenChannel:TRUE];
      return;
    }
    else
    {
      ...
      for (ImcConnectedServer* server in newServerList) {
        if ([server.server_address isEqualToString:serverAddress])
        {
          ...
          [server.channelConfigs enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
            if([(ChannelSetting*)obj isSearchable] && ((ChannelSetting*)obj).channelID == screen.channelIndex)
            {
              NSLog(@"3008 2908 fullScreenSearchMode 3");
              [self fullScreenSearchMode:screen.channelIndex:FALSE];
...
-(BOOL)noRecordDataDay
{
  if(currentServer == nil)
    NSLog(@"2908 noRecordDataDay currentServer == nil: T");
  else
    NSLog(@"2908 noRecordDataDay currentServer != nil, noRecordedData = %s", currentServer.availableDataDateList.count == 0 ? "T":"F");
...
-(void)fullScreenSearchMode:(NSInteger)channelIndex:(BOOL)checkRecordDataDayFlag
{
  ...
  if(!checkRecordDataDayFlag || [self noRecordDataDay])
  {
    return;
  }
...
//      }
    ...
    NSLog(@"2908 emitEventWithName SEARCH_NO_DATA 1");
  }
}
